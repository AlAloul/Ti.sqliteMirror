 ...
 * defaultsqlite == path to defaultdb
...
function Module(options) {
    ...
    this.defaultsqlite = options.defaultsqlite;
...
Module.prototype = {
    ...
    onofflineFunc : function() {
        ...
        setTimeout(function() {
            ...
            if (that.isDBvalide())
                ...
                if (that.defaultsqlite) {
                    var dummy = Ti.Database.install(that.defaultsqlite, that.dbname);
                    dummy.close();
                    that.fireEvent('load', {
                        success : true,
                        defaultsqlite : true
    ...
    isDBvalide : function() {
        ...
        if (isAndroid && tables.length > 0 || !isAndroid)
            testlink.close();
